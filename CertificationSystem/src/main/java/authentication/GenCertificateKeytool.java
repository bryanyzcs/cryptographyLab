 ...
 * 证书生成
 */
public class GenCertificateKeytool {
    ...
    public void genkey() {
        String[] arstringCommand = new String[] {
                ...
                "E:/CertifacateRepo/demo.keystore",
    ...
    public static void main(String[] args) {
        GenCertificateKeytool genCertificate = new GenCertificateKeytool();
        genCertificate.genkey();
        genCertificate.export();
    }
}
